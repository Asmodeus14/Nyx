 ...
 *
 * Disassembly of ssdt5.dat, Sat Sep  5 08:00:22 2026
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000017FE (6142)
 *     Revision         0x02
 *     Checksum         0xDE
 *     OEM ID           "DELL  "
...
DefinitionBlock ("", "SSDT", 2, "DELL  ", "DellRtd3", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP17.PXSX, UnknownObj)
    ...
    Scope (\_SB.PCI0.RP17)
    {
        ...
        Method (CSEX, 0, Serialized)
        {
            ...
            {
                Local1 = (Local1 - One)
                Local2 = TB2P /* \_SB_.PCI0.RP17.CSEX.TB2P */
        ...
        Method (CSPL, 0, Serialized)
        {
            ...
            {
                Local1 = (Local1 - One)
                Local2 = TB2P /* \_SB_.PCI0.RP17.CSPL.TB2P */
                If ((Local2 == 0xFFFFFFFF))
                {
                    Return (Zero)
                }
        ...
        Method (PON, 0, NotSerialized)
        {
            ...
            PSHR = PSD0 /* \_SB_.PCI0.RP17.PON_.PSD0 */
            PSD0 = Zero
            Local2 = 0x14
            While ((Local2 > Zero))
            {
